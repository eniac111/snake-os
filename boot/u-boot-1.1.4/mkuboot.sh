...
usage()
{
  ...
  echo "mkuboot.sh [equuleus]   [8181] | [8182 | 8133 | 8132 | all]"
}
...
if [ "$1" = "equuleus" ]  ; then
  echo "make equuleus"
  if [ "$2" = "8133" ] || [ "$2" = "8132" ] || [ "$2" = "8181" ] || [ "$2" = "8182" ] || [ "$2" = "all" ] ; then
    if [ "$2" = "all" ] ; then
      make_all_equuleus
    else
      make_for_board $1 $2
...
case "$1" in
	star_equuleus_8181_config|8181)
		echo make_for_board 8181
		;;

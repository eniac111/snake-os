...
#if 1
#define CONFIG_COMMANDS (CONFIG_CMD_DFL | CFG_CMD_I2C | CFG_CMD_PING | CFG_CMD_IDE | CFG_CMD_EXT2) /* eric@01082008 */
#else
#define CONFIG_COMMANDS (CONFIG_CMD_DFL | CFG_CMD_PCI | CFG_CMD_I2C | CFG_CMD_PING)
#endif

#define CONFIG_DOS_PARTITION	/* eric@01082008 */
...
#define CFG_ATA_BASE_ADDR	SYSPA_IDE_DEVICE_BASE_ADDR	/* eric@01082008 */

/* Offset for data I/O			*/
#define CFG_ATA_DATA_OFFSET	(0x0020)

/* Offset for normal register accesses	*/
#define CFG_ATA_REG_OFFSET	(CFG_ATA_DATA_OFFSET)

/* Offset for alternate registers	*/
#define CFG_ATA_ALT_OFFSET	(0x001C)

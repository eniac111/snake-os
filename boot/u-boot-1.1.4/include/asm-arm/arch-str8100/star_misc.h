...
#define	MISC_GPIOA_RESISTOR_CONFIG_REG_ADDR		MISC_MEM_MAP_ADDR(0x28)
#define	MISC_GPIOA_DRIVE_STRENGTH_CONFIG_REG_ADDR	MISC_MEM_MAP_ADDR(0x2C)
#define	MISC_FAST_ETHERNET_PHY_CONFIG_REG_ADDR	 	MISC_MEM_MAP_ADDR(0x30)

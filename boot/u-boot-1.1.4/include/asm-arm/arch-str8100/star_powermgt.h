 ...
 */
#define	PWRMGT_CLOCK_GATE_CONTROL0_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x00)
#define	PWRMGT_CLOCK_GATE_CONTROL1_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x04)
#define	PWRMGT_SOFTWARE_RESET_CONTROL_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x08)
#define	PWRMGT_SYSTEM_CLOCK_CONTROL_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x0C)
#define	PWRMGT_PLL_POWER_DOWN_CONTROL_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x10)
#define	PWRMGT_CPU_INITIALIZATION_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x14)
#define	PWRMGT_PAD_DRIVE_STRENGTH_CONTROL_REG_ADDR	PWRMGT_MEM_MAP_ADDR(0x1C)
#define	PWRMGT_USB_DEVICE_POWERMGT_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x20)
#define	PWRMGT_REGULATOR_CONTROL_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x24)
#define	PWRMGT_RTC_XTAL_CONTROL_REG_ADDR		PWRMGT_MEM_MAP_ADDR(0x28)
#define	PWRMGT_PLL2250_CONTROL_REG_ADDR			PWRMGT_MEM_MAP_ADDR(0x2C)

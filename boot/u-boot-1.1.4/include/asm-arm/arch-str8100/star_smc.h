 ...
 */
#define	SMC_MEM_BANK0_CONFIG_REG_ADDR	SMC_MEM_MAP_ADDR(0x00)

#define	SMC_MEM_BANK0_TIMING_REG_ADDR	SMC_MEM_MAP_ADDR(0x04)

#define	SMC_MEM_BANK1_CONFIG_REG_ADDR	SMC_MEM_MAP_ADDR(0x08)

#define	SMC_MEM_BANK1_TIMING_REG_ADDR	SMC_MEM_MAP_ADDR(0x0C)

#define	SMC_MEM_BANK2_CONFIG_REG_ADDR	SMC_MEM_MAP_ADDR(0x10)

#define	SMC_MEM_BANK2_TIMING_REG_ADDR	SMC_MEM_MAP_ADDR(0x14)

#define	SMC_MEM_BANK3_CONFIG_REG_ADDR	SMC_MEM_MAP_ADDR(0x18)

#define	SMC_MEM_BANK3_TIMING_REG_ADDR	SMC_MEM_MAP_ADDR(0x1C)
